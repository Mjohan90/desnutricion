...
<table class='form_data'>
    <tr>
        ...
        <td><select disabled id='txtUsuEmplID' name='txtUsuEmplID'>
    ...
    <tr>
        ...
        <td><input type='text' id='txtUsuNombre' name='txtUsuNombre' value='<?php if ($usu_row) {
				echo htmlspecialchars($usu_row['usu_nombre']);
			} ?>' maxlength='20' placeholder='Ingrese nombre'/></td>
    </tr>
    <tr>
    ...
    <tr hidden>
        ...
        <td><input type='text' id='txtUsuEstado' name='txtUsuEstado' value='<?php if ($usu_row) {
