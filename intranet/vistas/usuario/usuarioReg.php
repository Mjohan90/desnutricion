...
<table class='form_data'>
	<tr><td><label for='txtUsuNombre'>Nombre:</label></td>
		<td><input type='text' id='txtUsuNombre' name='txtUsuNombre' maxlength='20' placeholder='Ingrese nombre'/></td>
	</tr>
	<tr><td><label for='txtUsuContrasena'>Contrasena:</label></td>
		<td><input type='text' id='txtUsuContrasena' name='txtUsuContrasena' maxlength='32' placeholder='Ingrese contrasena'/></td>
	</tr>
