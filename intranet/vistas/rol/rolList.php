...
<table id='tblrol' class='datatable'>
	...
	<?php foreach ($rol_list as $row) { ?>
        <tr>
            ...
            <td hidden class='txt_center'><a href='#' onclick="rol_editar('<?php echo $row['rol_id']; ?>');">Editar</a>
            </td>
            <td hidden class='txt_center'><a href='#' onclick="rol_borrar('<?php echo $row['rol_id']; ?>');">Borrar</a>
            </td>
        </tr>
	<?php } ?>
</table>
