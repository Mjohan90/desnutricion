...
<table class='form_data'>
    <tr hidden>
        ...
        <td><input type='text' id='txtTriajeAtencID' name=txtTriajeAtencID' maxlength='' value='<?= $atenc_id ?>'
                   placeholder=''/>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td><label for='txtTriajeVarID'>Variable:</label></td>
    ...
    <tr>
        <td><label for='txtTriajeUmID'>Unidad de medida:</label></td>
    ...
    <tr>
        <td><label for='txtTriajeValor'>Valor:</label></td>
        <td><input type='text' id='txtTriajeValor' name='txtTriajeValor' maxlength='9' placeholder='Ingrese valor'/>
        </td>
    </tr>
</table>
<hr class='separator'/>
