...
<script>
    ...
    $(document).ready(function (e) {
        $(frm_triaje).find('#txtFecha').datepicker();
        ...
        $(frm_triaje).find('#txtFecha').change(function (e) {
            triaje_mostrarDatos();
        });
    ...
    function triaje_mostrarDatos() {
        var fecha  = encodeURIComponent(getDateYMD($(frm_triaje).find('#txtFecha').val()));
        var buscar = encodeURIComponent($(frm_triaje).find('#txtBuscar').val());
