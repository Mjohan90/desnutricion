...
<div id='frmReporte' class='listform'>
    <div class='form_top'>
        ...
        <div>
            ...
            <select name='txtAnio' id='txtAnio' class='txt120'>
				<?php for ($i = thisYear(); $i >= 2018; $i--) { ?>
...
<script>
    ...
    function empl_mostrarDatos() {
        var anio   = encodeURIComponent($('#txtAnio').val());
        var buscar = encodeURIComponent($('#txtBuscar').val());
        $(frm_empl).find('#datos').load('vistas/reportes/niveldesnutricionList.php?anio=' + anio + '&b=' + buscar);
    }
