// Plugin para crear un multiselect a partir de un select option
// Requiere el archivo dropdown.js
!function ($) {
    "use strict";
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            delimiterText                 : ', ',
            templates                     : {
                button        : '<button type="button" class="multiselect" data-toggle="dropdown">' +
                                '<span class="multiselect-selected-text"></span> <b class="caret"></b></button>',
                ul            : '<ul class="multiselect-container dropdown-menu"></ul>',
                filter        : '<li class="multiselect-item multiselect-filter">' +
                                '<div class="input-group"><input class="multiselect-search" style="width: 145px;" type="text">' +
                                '<a class="btn search-filter"></a></div></li>',
                filterClearBtn: '<a class="btn clear-filter"></a>',
        ...
        buildFilter: function () {
            ...
            if (this.options.enableFiltering || this.options.enableCaseInsensitiveFiltering) {
                var enableFilterLength = Math.max(this.options.enableFiltering ? 1 : 0, this.options.enableCaseInsensitiveFiltering ? 1 : 0);
