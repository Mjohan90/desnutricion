...
!function (a, b) {
    ...
    a.widget("ui.rangeSliderBar", a.ui.rangeSliderDraggable, {
        ...
        _create                : function () {
            ...
            return this._setWheelModeOption(this.options.wheelMode);
        }, destroy             : function () {
            this.options.leftHandle.unbind(".bar");
            this.options.rightHandle.unbind(".bar");
            this.options = null;
            return a.ui.rangeSliderDraggable.prototype.destroy.apply(this);
        }, _setOption          : function (a, b) {
    ...
    a.widget("ui.dateRangeSlider", a.ui.rangeSlider, {
        options               : {
            bounds       : {
                min: new Date(2010, 0).valueOf(),
                max: new Date(2010, 12).valueOf()
            },
            defaultValues: {
                min: new Date(2010, 1).valueOf(),
                max: new Date(2010, 12).valueOf()
            }
        }, _create            : function () {
    ...
    a.widget("ui.dateRangeSliderHandle", a.ui.rangeSliderHandle, {
        _steps                 : !1, _boundsValues: {}, _create: function () {
            ...
            d     = this._addThing(d, "FullYear", b, c.years);
            ...
            this._createSteps();
            return a.ui.rangeSliderHandle.prototype.update.apply(this);
        }, add                 : function (a, b) {
